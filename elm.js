...
var _user$project$Main$unpackMaybeList = F2(
	function (fn, ls) {
		return A3(
			_elm_lang$core$List$foldl,
			F2(
...
var _user$project$Main$updateBoard = F4(
	function (x, y, value, board) {
		return A4(
			_eeue56$elm_flat_matrix$Matrix$update,
			x,
			y,
			_user$project$Main$updatePlayer(value),
			board);
	});
var _user$project$Main$isMoveAvailabe = function (board) {
	return !_Skinney$elm_array_exploration$Array_Hamt$isEmpty(
		A2(
...
var _user$project$Main$f = F3(
	function (player, mPlayer, players) {
		var _p3 = mPlayer;
		if (_p3.ctor === 'Nothing') {
			return players;
		} else {
			return _elm_lang$core$Native_Utils.eq(_p3._0, player) ? {ctor: '::', _0: player, _1: players} : players;
		}
	});
var _user$project$Main$check = F2(
	function (player, array) {
		return A3(
			_elm_lang$core$List$foldr,
			_user$project$Main$f(player),
			{ctor: '[]'},
			_Skinney$elm_array_exploration$Array_Hamt$toList(array));
	});
var _user$project$Main$checkRows = F2(
	function (matrix, player) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Main$check(player),
			A2(
				_user$project$Main$unpackMaybeList,
				function (i) {
					return A2(_eeue56$elm_flat_matrix$Matrix$getRow, i, matrix);
				},
				A2(
...
var _user$project$Main$checkColumns = F2(
	function (matrix, player) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Main$check(player),
			A2(
				_user$project$Main$unpackMaybeList,
				function (i) {
					return A2(_eeue56$elm_flat_matrix$Matrix$getColumn, i, matrix);
				},
				A2(
					_elm_lang$core$List$range,
					0,
			...
			A2(
				...
				_Skinney$elm_array_exploration$Array_Hamt$fromList,
				{
					...
					_0: A2(
						...
						function (_p4) {
							var _p5 = _p4;
							return A3(_eeue56$elm_flat_matrix$Matrix$get, _p5._0, _p5._1, matrix);
						},
						{
							ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							function (_p6) {
								var _p7 = _p6;
								return A3(_eeue56$elm_flat_matrix$Matrix$get, _p7._0, _p7._1, matrix);
							},
							{
								ctor: '::',
...
var _user$project$Main$playerToString = function (player) {
	var _p8 = player;
	if (_p8.ctor === 'X') {
		return 'X';
	} else {
...
var _user$project$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{
		board: A3(_eeue56$elm_flat_matrix$Matrix$repeat, 3, 3, _elm_lang$core$Maybe$Nothing),
		status: _user$project$Main$Turn(_user$project$Main$X)
	},
	{
		ctor: '::',
...
var _user$project$Main$win = function (board) {
	var diagonals = A2(
		_elm_lang$core$List$map,
		_user$project$Main$checkDiagonals(board),
		{
			ctor: '::',
			_0: _user$project$Main$X,
			_1: {
				ctor: '::',
				_0: _user$project$Main$O,
				_1: {ctor: '[]'}
			}
		});
	var columns = A2(
		_elm_lang$core$List$map,
		_user$project$Main$checkColumns(board),
		{
			ctor: '::',
			_0: _user$project$Main$X,
			_1: {
	...
	var rows = A2(
		_elm_lang$core$List$map,
		_user$project$Main$checkRows(board),
		{
			ctor: '::',
			_0: _user$project$Main$X,
			_1: {
...
var _user$project$Main$updateGame = F4(
	function (x, y, status, board) {
		var _p10 = status;
		switch (_p10.ctor) {
			case 'Win':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Main$Win(_p10._0),
					_1: board
				};
			case 'Draw':
				return {ctor: '_Tuple2', _0: _user$project$Main$Draw, _1: board};
			default:
				var _p12 = _p10._0;
				var newBoard = A4(_user$project$Main$updateBoard, x, y, _p12, board);
				if (_elm_lang$core$Native_Utils.eq(newBoard, board)) {
					...
					if (_user$project$Main$isMoveAvailabe(newBoard)) {
						...
						if (_p11.ctor === 'Just') {
							return {
								ctor: '_Tuple2',
								_0: _user$project$Main$Win(_p12),
								_1: newBoard
							};
						} else {
							return {
								ctor: '_Tuple2',
								_0: _user$project$Main$Turn(
									_user$project$Main$swapPlayer(_p12)),
								_1: newBoard
							};
						}
					} else {
						return {ctor: '_Tuple2', _0: _user$project$Main$Draw, _1: newBoard};
					}
				}
		}
	});
...
var _user$project$Main$titleView = A3(
	...
	_user$project$Main$Title,
	{
		...
		_1: {
			ctor: '::',
			_0: _mdgriffith$style_elements$Element_Attributes$padding(30),
			_1: {ctor: '[]'}
		}
	},
	_mdgriffith$style_elements$Element$text('TIC TAC TOE'));
var _user$project$Main$Board = {ctor: 'Board'};
var _user$project$Main$UnitWrap = {ctor: 'UnitWrap'};
var _user$project$Main$UnitO = {ctor: 'UnitO'};
var _user$project$Main$UnitX = {ctor: 'UnitX'};
var _user$project$Main$playerCell = function (mPlayer) {
	var _p15 = mPlayer;
	if (_p15.ctor === 'Nothing') {
		...
		if (_p15._0.ctor === 'X') {
			...
			return A3(
				...
				_mdgriffith$style_elements$Element$text('O'));
		}
	}
};
var _user$project$Main$Cell = {ctor: 'Cell'};
...
var _user$project$Main$statusView = function (status) {
	var _p16 = status;
	switch (_p16.ctor) {
		case 'Turn':
			return A3(
				...
				{ctor: '[]'},
				{
					...
					_0: A3(
						...
						_user$project$Main$Clean,
						{ctor: '[]'},
						_mdgriffith$style_elements$Element$text('Next Turn: ')),
					_1: {
						ctor: '::',
						_0: A3(
							_mdgriffith$style_elements$Element$el,
							...
							_mdgriffith$style_elements$Element$text(
								_user$project$Main$playerToString(_p16._0))),
						_1: {ctor: '[]'}
					}
				});
		case 'Win':
			return A3(
				...
				{ctor: '[]'},
				{
					...
					_0: A3(
						...
						_user$project$Main$NextTurn,
						{ctor: '[]'},
						_mdgriffith$style_elements$Element$text('Win Player: ')),
					_1: {
						ctor: '::',
						_0: A3(
							_mdgriffith$style_elements$Element$el,
			...
			return A3(
				...
				{ctor: '[]'},
				{
					...
					_0: A3(
						...
						_user$project$Main$Clean,
						{ctor: '[]'},
						_mdgriffith$style_elements$Element$text('Draw')),
					_1: {ctor: '[]'}
				});
	}
};
var _user$project$Main$playersView = function (status) {
	return A3(
		...
		{
			ctor: '::',
			_0: _user$project$Main$statusView(status),
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$Reset = {ctor: 'Reset'};
var _user$project$Main$resetButton = A3(
	...
	_user$project$Main$Clean,
	{
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _mdgriffith$style_elements$Element_Events$onClick(_user$project$Main$Reset),
					_1: {ctor: '[]'}
				}
			}
		}
	},
	_mdgriffith$style_elements$Element$text('Reset'));
							...
							_1: {
								...
								_1: {
									...
									_0: _mdgriffith$style_elements$Element_Events$onClick(
										A2(_user$project$Main$Select, x, y)),
									_1: {ctor: '[]'}
								}
							}
						}
					},
					_user$project$Main$playerCell(player)),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Main$cells = F2(
	function (x, statuses) {
		return A2(
			...
			function (_p17) {
				var _p18 = _p17;
				return A3(_user$project$Main$cell, _p18._0, x, _p18._1);
			},
			_Skinney$elm_array_exploration$Array_Hamt$toIndexedList(statuses));
	});
var _user$project$Main$rowView = F2(
	function (i, statuses) {
		return A3(
			_mdgriffith$style_elements$Element$row,
			_user$project$Main$Clean,
			...
			A2(_user$project$Main$cells, i, statuses));
	});
var _user$project$Main$rows = function (matrix) {
	return A3(
		_mdgriffith$style_elements$Element$column,
		_user$project$Main$Board,
		{
	...
	return A2(
		...
		A3(
			...
			A3(
				...
				{
					ctor: '::',
					_0: _user$project$Main$titleView,
					_1: {
						ctor: '::',
						_0: A3(
							_mdgriffith$style_elements$Element$el,
							...
							A3(
								...
								{
									ctor: '::',
									_0: _user$project$Main$playersView(model.status),
									_1: {
										ctor: '::',
										_0: _user$project$Main$rows(model.board),
										_1: {
											ctor: '::',
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"Reset":[],"Select":["Int","Int"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
